...
function exp_Chirurgiensdentistes_10rule0_eval_expression(context) {
    // "Nombre de dentistes" = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Nombre de dentistes')  == 1);
    } else {
        return (feature.get('Nombre de dentistes')  == 1);
    }
}
...
function exp_Chirurgiensdentistes_10rule1_eval_expression(context) {
    // "Nombre de dentistes" = 3

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Nombre de dentistes')  == 3);
    } else {
        return (feature.get('Nombre de dentistes')  == 3);
    }
}
...
function exp_Chirurgiensdentistes_10rule2_eval_expression(context) {
    // "Nombre de dentistes" = 5

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Nombre de dentistes')  == 5);
    } else {
        return (feature.get('Nombre de dentistes')  == 5);
    }
}
...
function exp_Chirurgiensdentistes_10rule3_eval_expression(context) {
    // "Nombre de dentistes" = 7

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Nombre de dentistes')  == 7);
    } else {
        return (feature.get('Nombre de dentistes')  == 7);
    }
}